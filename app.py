...
lineaccesstoken = 'FydvGU0QLP97KaNVIgZDBX2agqJArMuTSAqjKhN4BIDmqM3tCkmFgmZ25bx558wd77CGfGOnAoorJJy3EZ+Zxo3KUr8gEXrp7HpRFe2qJObfy9pC1ReiNXzbyEXSL3/sVgtPOPNCnNSjDCLxugmGRgdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if msg == "สวัสดี":
            replyObj = TextSendMessage(text="สภาพ")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "กินข้าวไหม":
            replyObj = TextSendMessage(text="ไม่ ขอกินพิซซ่า")
            line_bot_api.reply_message(rtoken, replyObj)
            ...
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/c504478b-9b0c-4645-adba-29300c650fd4" 
